...
echo "## create uboot scripts"
"${HOST_DIR}/bin/mkimage" -C none -A arm -T script -d ${BR2_EXTERNAL}/board/nextthing/chip/flash_mlc.scr ${BINARIES_DIR}/flash_mlc.scr.bin
"${HOST_DIR}/bin/mkimage" -C none -A arm -T script -d ${BR2_EXTERNAL}/board/nextthing/chip/uboot.scr ${BINARIES_DIR}/boot.scr.bin
